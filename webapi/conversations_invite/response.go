...
//
//    conversationsInvite, err := UnmarshalConversationsInvite(bytes)
//    bytes, err = conversationsInvite.Marshal()

package conversations_invite

import "encoding/json"

func UnmarshalConversationsInvite(data []byte) (ConversationsInvite, error) {
	var r ConversationsInvite
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ConversationsInvite) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type ConversationsInvite struct {
