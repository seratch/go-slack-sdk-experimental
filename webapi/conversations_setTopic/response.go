...
//
//    conversationsSetTopic, err := UnmarshalConversationsSetTopic(bytes)
//    bytes, err = conversationsSetTopic.Marshal()

package conversations_setTopic

import "encoding/json"

func UnmarshalConversationsSetTopic(data []byte) (ConversationsSetTopic, error) {
	var r ConversationsSetTopic
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ConversationsSetTopic) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type ConversationsSetTopic struct {
