...
//
//    conversationsCreate, err := UnmarshalConversationsCreate(bytes)
//    bytes, err = conversationsCreate.Marshal()

package conversations_create

import "encoding/json"

func UnmarshalConversationsCreate(data []byte) (ConversationsCreate, error) {
	var r ConversationsCreate
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ConversationsCreate) Marshal() ([]byte, error) {
