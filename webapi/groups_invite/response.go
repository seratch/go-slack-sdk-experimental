...
//
//    groupsInvite, err := UnmarshalGroupsInvite(bytes)
//    bytes, err = groupsInvite.Marshal()

package groups_invite

import "encoding/json"

func UnmarshalGroupsInvite(data []byte) (GroupsInvite, error) {
	var r GroupsInvite
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GroupsInvite) Marshal() ([]byte, error) {
