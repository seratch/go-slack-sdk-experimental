...
//
//    usergroupsUpdate, err := UnmarshalUsergroupsUpdate(bytes)
//    bytes, err = usergroupsUpdate.Marshal()

package usergroups_update

import "encoding/json"

func UnmarshalUsergroupsUpdate(data []byte) (UsergroupsUpdate, error) {
	var r UsergroupsUpdate
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *UsergroupsUpdate) Marshal() ([]byte, error) {
