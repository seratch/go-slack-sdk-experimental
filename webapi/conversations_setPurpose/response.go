...
//
//    conversationsSetPurpose, err := UnmarshalConversationsSetPurpose(bytes)
//    bytes, err = conversationsSetPurpose.Marshal()

package conversations_setPurpose

import "encoding/json"

func UnmarshalConversationsSetPurpose(data []byte) (ConversationsSetPurpose, error) {
	var r ConversationsSetPurpose
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ConversationsSetPurpose) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type ConversationsSetPurpose struct {
