...
//
//    filesUpload, err := UnmarshalFilesUpload(bytes)
//    bytes, err = filesUpload.Marshal()

package files_upload

import "encoding/json"

func UnmarshalFilesUpload(data []byte) (FilesUpload, error) {
	var r FilesUpload
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *FilesUpload) Marshal() ([]byte, error) {
