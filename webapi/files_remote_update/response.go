...
//
//    filesRemoteUpdate, err := UnmarshalFilesRemoteUpdate(bytes)
//    bytes, err = filesRemoteUpdate.Marshal()

package files_remote_update

import "encoding/json"

func UnmarshalFilesRemoteUpdate(data []byte) (FilesRemoteUpdate, error) {
	var r FilesRemoteUpdate
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *FilesRemoteUpdate) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type FilesRemoteUpdate struct {
