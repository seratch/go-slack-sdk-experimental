...
//
//    filesInfo, err := UnmarshalFilesInfo(bytes)
//    bytes, err = filesInfo.Marshal()

package files_info

import "encoding/json"

func UnmarshalFilesInfo(data []byte) (FilesInfo, error) {
	var r FilesInfo
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *FilesInfo) Marshal() ([]byte, error) {
...
type FilesInfo struct {
	...
	ContentHighlightHTML *string   `json:"content_highlight_html,omitempty"`
	ContentHighlightCSS  *string   `json:"content_highlight_css,omitempty"` 
