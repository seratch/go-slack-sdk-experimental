...
//
//    filesRemoteShare, err := UnmarshalFilesRemoteShare(bytes)
//    bytes, err = filesRemoteShare.Marshal()

package files_remote_share

import "encoding/json"

func UnmarshalFilesRemoteShare(data []byte) (FilesRemoteShare, error) {
	var r FilesRemoteShare
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *FilesRemoteShare) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type FilesRemoteShare struct {
