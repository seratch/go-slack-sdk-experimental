...
//
//    usersLookupByEmail, err := UnmarshalUsersLookupByEmail(bytes)
//    bytes, err = usersLookupByEmail.Marshal()

package users_lookupByEmail

import "encoding/json"

func UnmarshalUsersLookupByEmail(data []byte) (UsersLookupByEmail, error) {
	var r UsersLookupByEmail
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *UsersLookupByEmail) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type UsersLookupByEmail struct {
