...
//
//    filesRevokePublicURL, err := UnmarshalFilesRevokePublicURL(bytes)
//    bytes, err = filesRevokePublicURL.Marshal()

package files_revokePublicURL

import "encoding/json"

func UnmarshalFilesRevokePublicURL(data []byte) (FilesRevokePublicURL, error) {
	var r FilesRevokePublicURL
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *FilesRevokePublicURL) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type FilesRevokePublicURL struct {
