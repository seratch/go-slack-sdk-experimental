...
type SelfPrefs struct {
	...
	StoriesVariant                                 *string         `json:"stories_variant,omitempty"`                                     
	EmojiPacksMostRecentAvailableTime              *int64          `json:"emoji_packs_most_recent_available_time,omitempty"`              
	EmojiPacksClickedPickerCta                     *bool           `json:"emoji_packs_clicked_picker_cta,omitempty"`                      
	EmojiPacksClickedCollectionCta                 *bool           `json:"emoji_packs_clicked_collection_cta,omitempty"`                  
	SeenP3LocaleChangeMessageKoKr                  *int64          `json:"seen_p3_locale_change_message_ko_kr,omitempty"`                 
	InboxViewsWorkspaceFilter                      *string         `json:"inbox_views_workspace_filter,omitempty"`                        
	DismissedConnectAutoApprovalModal              *string         `json:"dismissed_connect_auto_approval_modal,omitempty"`               
	HelpMenuOpenTimestamp                          *int64          `json:"help_menu_open_timestamp,omitempty"`                            
	XwsDismissedEducation                          *bool           `json:"xws_dismissed_education,omitempty"`                             
	XwsSeenEducation                               *int64          `json:"xws_seen_education,omitempty"`                                  
	EnableSlackConnectView                         *bool           `json:"enable_slack_connect_view,omitempty"`                           
	TasksView                                      *string         `json:"tasks_view,omitempty"`                                          
	DismissedAppLauncherAtlassianPromo             *bool           `json:"dismissed_app_launcher_atlassian_promo,omitempty"`              
	SeenToastNewLocaleLaunch                       *string         `json:"seen_toast_new_locale_launch,omitempty"`                        
	SeenToastNewLocaleLaunchTs                     *int64          `json:"seen_toast_new_locale_launch_ts,omitempty"`                     
	EmojiPacksClickedPickerPostInstallCta          *bool           `json:"emoji_packs_clicked_picker_post_install_cta,omitempty"`         
...
type TeamPrefs struct {
	...
	WhoCanManageIntegrations                    *SlackConnectAllowedWorkspaces `json:"who_can_manage_integrations,omitempty"`                       
	...
	WhoCanViewMessageActivity                   *SlackConnectAllowedWorkspaces `json:"who_can_view_message_activity,omitempty"`                     
	...
	WhoCanManageGuests                          *SlackConnectAllowedWorkspaces `json:"who_can_manage_guests,omitempty"`                             
	WhoCanCreateSharedChannels                  *string                        `json:"who_can_create_shared_channels,omitempty"`                    
	WhoCanManageSharedChannels                  *SlackConnectAllowedWorkspaces `json:"who_can_manage_shared_channels,omitempty"`                    
	WhoCanPostInSharedChannels                  *SlackConnectAllowedWorkspaces `json:"who_can_post_in_shared_channels,omitempty"`                   
	WhoCanManageEXTSharedChannels               *SlackConnectAllowedWorkspaces `json:"who_can_manage_ext_shared_channels,omitempty"`                
	WhoCanDmAnyone                              *SlackConnectAllowedWorkspaces `json:"who_can_dm_anyone,omitempty"`                                 
	...
	WhoCanApproveEXTSharedChannelInvites        *SlackConnectAllowedWorkspaces `json:"who_can_approve_ext_shared_channel_invites,omitempty"`        
	WhoCanCreateEXTSharedChannelInvites         *SlackConnectAllowedWorkspaces `json:"who_can_create_ext_shared_channel_invites,omitempty"`         
	...
	WhoCanCreateWorkflows                       *SlackConnectAllowedWorkspaces `json:"who_can_create_workflows,omitempty"`                          
	...
	WhoCanCreateChannelEmailAddresses           *SlackConnectAllowedWorkspaces `json:"who_can_create_channel_email_addresses,omitempty"`            
	...
	WhoCanRequestEXTSharedChannels              *SlackConnectAllowedWorkspaces `json:"who_can_request_ext_shared_channels,omitempty"`               
	...
	DisplayExternalEmailAddresses               *bool                          `json:"display_external_email_addresses,omitempty"`                  
	EnableInfoBarriers                          *bool                          `json:"enable_info_barriers,omitempty"`                              
	EnableMpdmToPrivateChannelConversion        *bool                          `json:"enable_mpdm_to_private_channel_conversion,omitempty"`         
	SlackConnectFileUploadSharingEnabled        *bool                          `json:"slack_connect_file_upload_sharing_enabled,omitempty"`         
